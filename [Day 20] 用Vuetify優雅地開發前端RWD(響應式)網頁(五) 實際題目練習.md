# [Day 20] 用Vuetify優雅地開發前端RWD(響應式)網頁(五) 實際題目練習

今天我們要開始來填充我們的購物頁面，我們先來用ChatGPT產生一筆假資料來假裝我們從後端取得了的資料：
...
<template>
    ...
    <v-container>
        <v-row>
            <v-col v-for="item in searching" :key="item.id" cols="12" sm="6" md="4">
...
[演示畫面](https://www.awesomescreenshot.com/video/21058448?key=1184299c437182c2d02220083ba54800)

# **換頁功能**

這裏我對於一次過將所有物品顯示在同一頁不太滿意，因此我想要做到換頁的功能：

![https://ithelp.ithome.com.tw/upload/images/20230925/20162542BNlVOMZf0a.png](https://ithelp.ithome.com.tw/upload/images/20230925/20162542BNlVOMZf0a.png)

我們依然可以簡單地用computed去取得我們要的東西：
...
有注意到我return的部分，是return this.searching，而不是this.items，這樣我們就能同時分頁也同時保留搜尋功能。

在經歷過這個簡單的頁面開發，我們可以知道其實computed很好用，很多乍看之下會使用method來完成的工作其實用computed就能做到了。明天再和大家分享點擊進入購物的頁面。
...
[點擊這裏可以看到成果](https://liangjin0228.github.io/PracticeVuetify-pet/#/shop)
